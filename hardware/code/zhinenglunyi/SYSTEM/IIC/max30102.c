...
void maxim_get(float *rate,float *spo2)
{ 
...
void max_senddat(char *s)
{
	while((*s)!='\0')
	{
	USART_SendData(USART1,*s);while(!USART_GetFlagStatus(USART1, USART_FLAG_TC));
		s++;
	}
}
